...
namespace PumpData.RealTimeParam
{
        ...
        : IDataSeedContributor, ITransientDependency
    {
        ...
        public ParameterDataSeederContributor(IRepository<Parameter, Guid> parameterRepository)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            while (!sr.EndOfStream)
            {
                ...
                var parameterhas = await _parameterRepository.FindAsync(p => p.P_date == Convert.ToDateTime(arr[0]));

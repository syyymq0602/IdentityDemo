...
namespace BooksAppStore.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update BooksAppStoreDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update BooksAppStoreEfCoreEntityExtensionMappings to extend the IdentityUser entity
